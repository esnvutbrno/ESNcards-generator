...
#                                                 ESNcard
# +-----------------------------------------------------------------------------------------------------------------+
# | ⇤- PhotoSize.w  -⇥⇤------ photoTextSpacing ---------⇥⇤------------------  TextSize.w  --------------------⇥     |
# | +----------------+ ⤒                                                                                            |
# | |                | |                ↑                Name Surname                                               |
# | |                | |                |               ⤒                                                           |
# | |                | |                |            rowDelta                                                       |
# | |      Photo     | |           TextSize.h           ⤓ Nationality                DD         MM          YY      |
# | |                | PhotoSize.h      |                                                                           |
# | |                | |                |                 Studies at                                                |
# | |                | |                |                                                                           |
# | |                | |                |                 ESN Section                DD         MM          YY      |
# | +----------------+ ⤓                ⤓                                                                           |
# | ⇤---------------------- textDelta ------------------⇥⇤-------- dateDelta -------⇥⇤ dayDelta ⇥⇤ dayDelta ⇥       |
# +-----------------------------------------------------------------------------------------------------------------+
#
#                                       A4 paper
#                                       A4Size.w
...
# |                                                ⤒                                   |
# |                                             yBorder                                |
# |       xLeftLimit              yTopLimit                           xRightLimit      |
# |⇤ xBorder ⇥☒                       ☒            ⤓                       ☒⇤ xBorder ⇥|
# |         ⤒ +-----------+            +-----------+            +-----------+          |
# |         | |  ESNcard  |            |  ESNcard  |            |  ESNcard  |          |
# |         | +-----------+            +-----------+            +-----------+          |
# |         |                                ⤒                                         |
# |     yIncrement                       ySpacing                                      |
# |         ⤓ ⇤---    xIncrement    ---⇥     ⤓                                         |
